$(function(){
    ...
    //手机区域内容
    $.get('http://jx.xuzhixiang.top/ap/api/detail.php',{id:$('.bottomlist ul').attr('data-id')})
    .then((data) => {
    ...
    //家电区域列表
    $.get('http://jx.xuzhixiang.top/ap/api/detail.php',{id:$('.houselist ul').attr('data-id')})
    .then((data) => {
    ...
    //智能区域列表
    $.get('http://jx.xuzhixiang.top/ap/api/detail.php',{id:$('.mindlist ul').attr('data-id')})
    .then((data) => {
    ...
    $.get('http://jx.xuzhixiang.top/ap/api/detail.php',{id:$('.matchlist ul').attr('data-id')})
    .then((data) => {
    ...
    //
    $.get('http://jx.xuzhixiang.top/ap/api/detail.php',{id:197045},function(data){
